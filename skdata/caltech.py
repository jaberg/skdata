...
class BaseCaltech(object):
    ...
    def home(self, *suffix_paths):
        subdir = self.__class__.__name__
        return path.join(get_data_home(), subdir, *suffix_paths)
...
class KfoldClassification(object):
    def __init__(self, caltech, K, n_train, n_test, seed):
        """
        Constructs splits for K-fold cross-validation of a classifier.

        caltech - a low-level caltech object
        K - number of splits
        n_train - int
        n_test - int
        seed - int
